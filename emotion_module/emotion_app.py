...
def recommend_button(emotion, key):
...
@st.fragment
def render_live_detection(prefix, title, show_recommend_button=False):
...
def run_text_flow():
    ...
    if "text_emotions" in st.session_state:
        ...
        recommend_button(dominant_emotion, "recommend_text")
...
def run_image_flow():
    ...
    recommend_button(dominant_emotion, "recommend_image")
...
def run_live_camera_flow():
    ...
    render_live_detection("live_camera", "Live emotion", show_recommend_button=True)
...
def run_video_flow():
    ...
    if "video_emotions" in st.session_state:
        ...
        recommend_button(dominant_emotion, "recommend_video")
...
def run_mixed_flow():
    ...
    if visual_mode == "Image":
        ...
        render_live_detection("mixed_live_camera", "Mixed live emotion")
    ...
    if st.button("Analyze Mixed", type="primary"):
        ...
        st.session_state.mixed_emotions = fuse_emotions(
            text_emotions,
            visual_emotions,
            text_weight,
            1.0 - text_weight,
    ...
    if "mixed_emotions" in st.session_state:
        ...
        recommend_button(dominant_emotion, "recommend_mixed")
